...
const AssignMatch = ({ tournament, onClose }) => {
  ...
  useEffect(() => {
    axios
      .post("https://athle-track-backend-ecru.vercel.app/api/team/get-team-names", {
  ...
  const handleAssignMatch = () => {
    if (teamA && teamB && matchDate) {
      ...
      axios.post("https://athle-track-backend-ecru.vercel.app/api/tournaments/create-match-and-save-to-tournament",{
        teamAId:teamA,
        teamBId:teamB,
