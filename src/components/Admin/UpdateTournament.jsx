...
const UpdateTournament = ({ tournament, onClose }) => {
  ...
  const handleFormSubmit = (e) => {
    ...
    axios
      .put(
        `https://athle-track-backend-ecru.vercel.app/api/tournaments/${tournament._id}`,
        updatedData,
        {
          headers: {
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <img
              src={
                typeof formData.posterImage === "string"
                  ? `https://athle-track-backend-ecru.vercel.app/public/${formData.posterImage.split("\\").pop()}`
        ...
        <div>
          ...
          {formData.organizerImage && (
            <img
              src={
                typeof formData.organizerImage === "string"
                  ? `https://athle-track-backend-ecru.vercel.app/public/${formData.organizerImage.split("\\").pop()}`
                  : URL.createObjectURL(formData.organizerImage)
              }
              alt="Organizer"
              className="mt-2 w-32 h-32 object-cover"
            />
