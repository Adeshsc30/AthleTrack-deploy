...
const AddTeamForm = ({ onClose }) => {
  ...
  const handleCreateTeam = () => {
    ...
    axios
      .post("https://athle-track-backend-ecru.vercel.app/api/team/create-team-step-1", formData, {
        headers: {
  ...
  const assignCoachToTeam = () => {
    ...
    axios
      .post(`https://athle-track-backend-ecru.vercel.app/api/team/add-coach-details`, formData, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`,
        },
  ...
  const addPlayersToTeam = () => {
    ...
    axios
      .post(`https://athle-track-backend-ecru.vercel.app/api/team/add-player-details`, formData, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`,
        },
