...
import AdeshShahi from "../assets/AdeshShahi.jpg";
import Santosh from "../assets/Santosh.jpg";
import Adarsha from "../assets/Adarsha.jpg";
import Bikesh from "../assets/Bikesh.jpg";
          ...
          <div className="flex flex-col items-center justify-center mb-12">
            ...
            <div className="bg-gray-800/80 backdrop-blur-sm rounded-xl shadow-2xl p-8 border border-orange-500/30 max-w-4xl">
              <div className="space-y-6">
                <p className="text-orange-300 text-lg leading-relaxed">{aboutusData.firstParagraph}</p>
                <div className="h-0.5 w-full bg-gradient-to-r from-transparent via-orange-500 to-transparent"></div>
                <p className="text-gray-300 text-lg leading-relaxed">{aboutusData.secondParagraph}</p>
              </div>
            </div>
          </div>
        </div>
