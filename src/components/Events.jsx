...
const Events = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response = await axios.get("https://athle-track-backend-ecru.vercel.app/api/tournaments/");
      ...
      try {
        ...
        if (selectedTournamentData && selectedTournamentData.matches.length > 0) {
          ...
          const matchPromises = selectedTournamentData.matches.map((matchId) =>
            axios.get(`https://athle-track-backend-ecru.vercel.app/api/match/matches/${matchId}`)
          );
          ...
          const enrichedMatchData = matchData.map((match) => {
            ...
            return {
              ...match,
              location: selectedTournamentData.location,
              team1Score,
              team2Score,
            };
          });
  ...
  const visibleDates = Object.keys(groupedMatches).slice(visibleRange[0], visibleRange[1]);
            ...
            <div className="w-full md:w-2/3">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  disabled={visibleRange[1] >= Object.keys(groupedMatches).length}
                  className={`p-2 rounded-full ${
