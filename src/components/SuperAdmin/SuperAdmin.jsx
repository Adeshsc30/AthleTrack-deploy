...
function SuperAdmin() {
  ...
  useEffect(() => {
    axios
      .get("https://athle-track-backend-ecru.vercel.app//api/superadmin/check-token", {
  ...
  useEffect(() => {
    axios
      .get("https://athle-track-backend-ecru.vercel.app//api/superadmin/get-admins", {
        headers: {
  ...
  const handleAdminFormSubmit = (e) => {
    ...
    const url = isEditMode
      ? `https://athle-track-backend-ecru.vercel.app//api/superadmin/update-admin/${adminFormData._id}`
      : "https://athle-track-backend-ecru.vercel.app//api/superadmin/create-admin";
